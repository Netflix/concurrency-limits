 ...
 */
public interface SampleWindow<SELF extends SampleWindow> {
    SELF addSample(long rtt, int maxInFlight);

    SELF addDroppedSample(int maxInFlight);
